...
to_account = Account(private_key="96F97A96425D3A356350BCA2D59079A4B41891EC02306DFF36C859726423D44C")
...
#deploy_contract(to_account, "HelloWorld.py", init)
...
def call_contract(to_account, contract_addr):
    ...
    for contract in contracts:
        if contract.address == contract_addr:  
            ...
            resp = contract.call(method="HelloworldContract.recall", params=[])
            pprint(resp)
...
call_contract(to_account, '814ad506f6b07097200546cb7ea855a65b2bf7ad')
